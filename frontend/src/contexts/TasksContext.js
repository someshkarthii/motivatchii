...
export const TasksProvider = ({ children }) => {
  ...
  const fetchTasks = async () => {
    try {
      ...
      const response = await fetch("https://backend-purple-field-5089.fly.dev/api/tasks/", {
  ...
  const deleteTask = async (taskId) => {
    try {
      // delete in django
      const response = await fetch(`https://backend-purple-field-5089.fly.dev/api/tasks/${taskId}/`, {
        method: "DELETE",
        credentials: "include",
      });
  ...
  const markComplete = async (taskId, onReward) => {
    try {
      ...
      const response = await fetch(`https://backend-purple-field-5089.fly.dev/api/tasks/${taskId}/complete/`, {
        method: "POST",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
  ...
  const markIncomplete = async (taskId, onPenalty) => {
    try {
      ...
      const response = await fetch(`https://backend-purple-field-5089.fly.dev/api/tasks/${taskId}/mark_incomplete/`, {
        method: "POST",
        credentials: "include",
        headers: {
          "Content-Type": "application/json",
  ...
  useEffect(() => {
    ...
    const pollOverdueTasks = async () => {
      try {
        ...
        const res = await fetch("https://backend-purple-field-5089.fly.dev/api/tasks/", {
          credentials: "include",
        });
        if (!res.ok) {
        ...
        await Promise.all(overdueTasks.map(async (task) => {
          try {
            ...
            const resp1 = await fetch(`https://backend-purple-field-5089.fly.dev/api/tasks/${task.id}/`, {
              method: "PATCH",
              credentials: "include",
            ...
            const resp2 = await fetch("https://backend-purple-field-5089.fly.dev/api/tamagotchi/health/", {
              method: "POST",
              credentials: "include",
              headers: { "Content-Type": "application/json" },
